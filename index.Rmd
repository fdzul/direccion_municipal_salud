...
```{r gauge1_map_risk, out.height='100%', out.width = '100%', fig.align = "center", fig.width=1.5, fig.height=.8, message=FALSE, error = FALSE, warning=FALSE}
...
```{r gauge2_map_risk, out.height='100%', out.width = '100%', fig.align = "center", fig.width=1.5, fig.height=.8, message=FALSE, error = FALSE, warning=FALSE}
...
```{r gauge3_map_risk, out.height='100%', out.width = '100%', fig.align = "center", fig.width=1.5, fig.height=.8, message=FALSE, error = FALSE, warning=FALSE}
    block_loc <- blocks[risk,]
